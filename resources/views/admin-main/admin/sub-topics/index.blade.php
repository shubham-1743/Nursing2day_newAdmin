...
<div class="container-fluid">
    ...
    <!-- Top action buttons -->
    <div class="mb-3">
        <a href="{{url('admin/subtopices/create')}}" class="btn btn-success btn-sm">+ Add New Sub-Topic</a>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <a class="dropdown-item" href="{{ url('admin/subtopices/{id}/edit') }}" onclick="check_perform_sedit()">
