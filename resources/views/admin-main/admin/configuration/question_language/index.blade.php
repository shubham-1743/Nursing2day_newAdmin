...
<div class="container-fluid">
    <h3>Question Languages</h3>

    <!-- Top action buttons -->
    <div class="mb-3">
        <a href="{{url('admin/Languages/create')}}" class="btn btn-success btn-sm">+ Add New Question Languages</a>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">                                      
                                        <a href="{{ url('admin/Languages/{id}/edit') }}" name="editallfrm" ><span class="fa fa-edit"></span>&nbsp;Edit</a>
