...
<div class="container-fluid">
    ...
    <!-- Top action buttons -->
    <div class="mb-3">
        <a href="{{url('admin/courses/create')}}" class="btn btn-success btn-sm">+ Add New Courses</a>
        ...
        <form id="delete-form" action="{{ route('groups.destroy', $groupId ?? 1) }}" method="POST" style="display: none;">
            @csrf
            @method('DELETE')
        </form>
    </div>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="{{ url('admin/courses/{id}/edit') }}" onclick="check_perform_sedit()">
