...
<div class="container-fluid">
    ...
    <!-- Top action buttons -->
    <div class="mb-3">
        <a href="{{url('admin/news/create')}}" class="btn btn-success btn-sm">+ Add New News
        </a>
                ...
                <table class="table table-bordered mb-0">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>1</td>
                            <td>Rajasthan ANM Recruitment 2022 [राजस्थान एएनएम भर्ती 2022]		</td>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">                                      
                                        <a href="{{ url('admin/news/{id}/edit') }}" name="editallfrm" ><span class="fa fa-edit"></span>&nbsp;Edit</a>
