...
<div class="container-fluid">
    ...
    <!-- Top action buttons -->
    <div class="mb-3">
        <a href="{{url('admin/seos/create')}}" class="btn btn-success btn-sm">+ Add New SEO
        </a>
                ...
                <table class="table table-bordered mb-0 ">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Carts	</td>
                            <td>view</td>
                          <td>Best CHO Coaching in Jaipur, 	</td>
                          <td>Norcet Coaching in Jaipur, </td>
                          <td>Best Online Nursing 
                        </td>
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">                                  
                                        <a href="{{ url('admin/seos/{id}/edit') }}" name="editallfrm" ><span class="fa fa-edit"></span>&nbsp;Edit</a>
