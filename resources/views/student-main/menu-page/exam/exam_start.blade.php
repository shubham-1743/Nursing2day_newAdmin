...
<body>
    ...
    <div id="cards-container">
        ...
        <div class="guideline-card">
            <div class="p-3 border-bottom bg-light"><strong>Jodhpur AIIMS Exam Paid Model Paper 7 Model Paper 7</strong></div>
            <div class="progress">
        ...
        <!-- CARD 4 -->
        <div class="guideline-card">
            <div class="p-3 border-bottom bg-light"><strong> Model Paper 7</strong></div>
            <div class="progress">
        ...
        <div class="guideline-card" id="agreementCard">
            <div class="p-3 border-bottom bg-light"><strong>Instructions of Jodhpur AIIMS Exam Paid Model Paper 7</strong></div>
            <div class="p-4">
              
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="agreement" id="agreeRadio">
                    <label class="form-check-label" for="agreeRadio">Do all question</label>
                </div>
    ...
    <script>
      ...
      $(document).ready(function () {
        ...
        $('#startTestBtnFinal').click(function () {
          window.location.href = "{{route('student.startEx')}}";
        });
      });
    </script>
