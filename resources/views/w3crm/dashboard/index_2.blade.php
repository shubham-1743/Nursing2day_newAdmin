									...
									<div class="card-body">
										<div class="d-flex align-items-center">
											...
											<div class="total-projects ms-3">
												<h3 class="text-success count">120</h3>
                    ...
                    <div class="card box-hover ">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="total-projects ms-3">
                                    <h3 class="text-primary count">70</h3>
                    ...
                    <div class="card box-hover ">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="total-projects ms-3">
                                    <h3 class="text-purple count">12</h3>
                    ...
                    <div class="card box-hover">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="total-projects ms-3">
                                    <h3 class="text-danger count">22</h3>
                    ...
                    <div class="card box-hover">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="total-projects ms-3">
                                    <h3 class="text-purple count">150</h3>
